...
<body>
<%
Dim objCommand, objRS, intParcelNo, strAddress, strQueryString, intSet, strTitle1, strTitle2, strTitle3, strTitle4, strName, intPrclNo, strAddr, strNam, intSect, intTwp, intRange
...
End if
	...
	NewParcl =  ChckStar(intParcelNo, checkstr)
	intParcelNo = checkstr

	intParcelNo = replace(intParcelNo, "*", "%")
	strQueryString = "WHERE TXPRCL Like '" & intParcelNo & "' ORDER BY TXPRCL, TXYEAR, TXFLAG;"
	intParcelNo = replace(intParcelNo, "%", "*")
	intSet = 1
	strTitle1 = "Parcel No."
	strTitle2 = "Year"
