...
<%
	...
	'response.write(" the varcid is here : " & varcid )
...
<%
	...
	Else
		If strResponse = "" AND strSearchAgain = "" Then
			response.Redirect("disclaimer_value.asp")
		End If
	End If
...
<table border="0" cellspacing="0" cellpadding="0">
	<tr valign="top">
		...
		<td width="550">
			...
			<%
				If varcid = 54 or varcid = 34 or varcid = 67 or  varcid = 48 or varcid = 87 or varcid = 65 or varcid = 53 or varcid = 42 or varcid=75 or varcid = 78 Then
			%>
			<!-- #include file="SearchByName.asp" -->
			<%
				End If
			%>
				...
				<br>
			<%
				If varcid = 54 or varcid = 34 or varcid = 21 or varcid = 26 or varcid = 65 or varcid = 48 or varcid = 67 or varcid = 75 or varcid = 87 or varcid = 76 or varcid = 53 or varcid = 47 or varcid = 42 or varcid = 74 or varcid = 84 or varcid = 78 Then
			%>
			<!-- #include file="SearchByParcel.asp" -->
				<br>
				<br>
			...
			<%
				If varcid = 61 Then  ' Just for Pope County to take out the "E911"   LEM 03/02/09
			%>
				<tr>
              ...
              <b>*25*</b> in the Address Search field would produce a list
