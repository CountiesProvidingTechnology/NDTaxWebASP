	...
	'if rs("RecNum") = 0
		...
		'Response.write(" the value for the objRSV2(RecNum) :  " & objRSV2("RecNum") )
			...
			'Response.Write(" if strRID < objRSV2(recnum)  : ")
				...
				Response.Write("<a class='pLink' href='Parcel_Rock.asp?pid=" & strPID & "&tid=1&rid="& strRID + 1 &"'>Next Record</a>")
					if strRID >= 1 Then
					Response.Write("<a class='pLink' href='Parcel_Rock.asp?pid=" & strPID & "&tid=1&rid="& strRID - 1 &"'>| Previous Record</a>")
					Response.Write(" the value for the objRSV2(RecNum) :  " & objRSV2("RecNum") )
					else
						'if strRID = 0 then
						'Response.Write("<a class='pLink' href='Parcel_Rock.asp?pid=" & strPID & "&tid=1&rid=" & strRID & "'>Total Value</a>")
				...
				Response.Write("<a class='pLink' href='Parcel_Rock.asp?pid=" & strPID & "&tid=1&rid=0&yr="& objRS("TXYEAR") &"'>Total </a>")
				Response.Write("<a class='pLink' href='Parcel_Rock.asp?pid=" & strPID & "&tid=1&rid="& strRID - 1 &"&yr="& objRS("TXYEAR") &"'>| Previous Record</a>")
				else
				'Response.Write(" the  value for the rid : " & rid )
				'Response.Write("<a class='pLink' href='Parcel_Rock.asp?pid=" & strPID & "&tid=1&rid="& strRID + 1 &"&yr="& objRS("TXYEAR") &"'>Next Record</a>")
					...
					if strRID = 0 then
					Response.Write("<a class='pLink' href='Parcel_Rock.asp?pid=" & strPID & "&tid=1&rid=" & objRSV2("RecNum") & "&yr="& objRS("TXYEAR") &"'>| Previous Record</a>")
					'Response.Write(" the  value for the rid : " & rid )
					end if
