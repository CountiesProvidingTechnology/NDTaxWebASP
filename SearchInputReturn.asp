...
<%
	...
	If varcid = ""  then
	'response.Write(" the value of varcid ; " & varcid )
	varcid = request.QueryString("cid")
	'response.Write(" the value of varcid ; " & varcid )
	end if
	'cid = Session("CountyID")
...
<table border="0" cellspacing="0" cellpadding="0">
	<tr valign="top">
		...
		<td width="550">
			<%
				If varcid = 54 or varcid = 34 or varcid = 67 or varcid = 87 or varcid = 65 or varcid = 53 or varcid = 42 or varcid = 45 or varcid = 77 or varcid = 48 or varcid = 64 or varcid = 51 or varcid = 41 or varcid = 75 or varcid = 78 or varcid = 99  Then
			%>
			...
			%>
				...
				<br>
			<%
				If varcid = 54 or varcid = 34 or varcid = 21 or varcid = 65 or varcid = 61 or varcid = 67 or varcid = 75 or varcid = 87 or varcid = 76 or varcid = 53 or varcid = 47 or varcid = 48 or varcid = 26 or varcid = 74 or varcid = 42 or varcid = 77 or varcid = 45 or varcid = 64 or varcid = 51 or varcid = 41 or varcid = 80 or varcid = 78 or varcid = 99  Then
			%>
