...
<table width="600" border="0" cellpadding="0" cellspacing="0">
	...
	<tr>
		...
		<td width="700" class="STitle">Legal Description</td>
		<td width="1" class="STitle"></td>
		<td width="10" class="STitle"></td>
	</tr>
	<tr>
...
if objRS11.EOF Then
		...
		Response.Write("<td width='700' class='rText'>" & objRS11("TXDESC") & "</td>")
		Response.Write("</tr>")
...
response.Write("<td width='600' align='right' colspan='2'><A HREF='http://cpuimei.com:41080/iText/MNPAS2010.jsp?cid=" & varcid & "&pid=" & strPID & "&asy=" & objRSPYGEN("TXYEAR")  & "' target=_new, toolbar=no, menubar=no ><IMG SRC='images/PrntAppraslInfo.gif'></A></td>")
...
<tr>
	...
	<tr>
		...
		<td width="10" class="rText"></td>
		<td class="rText">Lot 1</td>
		<td  class="rText" align="right" ><%= objRSCAMA("Lot1By1") %>x<%= objRSCAMA("Lot1By2") %></td>
	</tr>
	<tr>
		...
		<td width="10" class="rText"></td>
		<td class="rText">Lot 2</td>
		<td  class="rText" align="right" ><%= objRSCAMA("Lot2By1") %>x<%= objRSCAMA("Lot2By2") %></td>
	</tr>
	<tr>
		...
		<td width="10" class="rText"></td>
		<td class="rText">Total Lot Sq Feet</td>
		<td  class="rText" align="right" ><%= objRSCAMA("LotSqFt") %></td>
	</tr>
	<tr>
...
If  varcid=34 or varcid=48 or varcid=84 Then         'Creates  formatted parcel XX-XXX-XXXX  (2-3-4)
		strleftChars = Left(strtrimdata, 2)
		strmidChars = Mid(strtrimdata, 4, 3)
...
While Not objRSCAMASum.EOF
	if objRSCAMASum("Item") <> ""     Then
		Response.Write("<tr valign='top'>")
		  Response.Write("<td align='center' width='80' class='rText'>" & calcZeroCAMASum("Yrblt") & "</td>")
